...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny() {
        var tmp = DaneUczelni.Przedmioty
            ...
            .OrderBy(s => s.DataStartu)
            .FirstOrDefault();
        //throw Niezaimplementowano(nameof(Zadanie04_PierwszyPrzedmiotAnalityczny));
        return new[] {tmp?.Nazwa?? "Nie znaleziono takowego przedmiotu"};
    }
    ...
    public IEnumerable<string> Zadanie05_CzyIstniejeNieaktywneZapisanie() {
        var isThere = DaneUczelni.Zapisy.Any(s => !s.CzyAktywny);
        //throw Niezaimplementowano(nameof(Zadanie05_CzyIstniejeNieaktywneZapisanie));
        return new[] { isThere ? "YEAHH" : "NAHHH" };
    }
    ...
    public IEnumerable<string> Zadanie06_CzyWszyscyProwadzacyMajaKatedre() {
        var tmp = DaneUczelni.Prowadzacy.All(s => !string.IsNullOrEmpty(s.Katedra));
        //throw Niezaimplementowano(nameof(Zadanie06_CzyWszyscyProwadzacyMajaKatedre));
        return new[] { tmp ? "YEAHH" : "NAHHH" };
    }
    ...
    public IEnumerable<string> Zadanie07_LiczbaAktywnychZapisow() {
        var tmp = DaneUczelni.Zapisy.Count(s => s.CzyAktywny);
        //throw Niezaimplementowano(nameof(Zadanie07_LiczbaAktywnychZapisow));
        return new[] { tmp.ToString() };
    }
